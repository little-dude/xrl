...
impl Client {
    ...
    pub fn notify(&self, method: &str, params: Value) -> ClientResult<()> {
    ...
    /// "view_id":"view-id-1"}}
    /// ```
    pub fn scroll(&self, view_id: ViewId, first_line: u64, last_line: u64) -> ClientResult<()> {
    ...
    pub fn undo(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "undo", None as Option<Value>)
    }

    pub fn redo(&self, view_id: ViewId) -> ClientResult<()> {
    ...
    pub fn left_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn right(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "move_right", None as Option<Value>)
    }

    pub fn right_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn up(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "move_up", None as Option<Value>)
    }

    pub fn up_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn down(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "move_down", None as Option<Value>)
    }

    pub fn down_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn backspace(&self, view_id: ViewId) -> ClientResult<()> {
        self.del(view_id)
    }

    pub fn delete(&self, view_id: ViewId) -> ClientResult<()> {
    ...
    pub fn page_up(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "scroll_page_up", None as Option<Value>)
    }

    pub fn page_up_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn page_down(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "scroll_page_down", None as Option<Value>)
    }

    pub fn page_down_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn line_start(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "move_to_left_end_of_line", None as Option<Value>)
    }

    pub fn line_start_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn line_end(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "move_to_right_end_of_line", None as Option<Value>)
    }

    pub fn line_end_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn document_begin(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn document_begin_sel(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(
            view_id,
    ...
    pub fn select_all(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "select_all", None as Option<Value>)
    }

    pub fn collapse_selections(&self, view_id: ViewId) -> ClientResult<()> {
    ...
    pub fn drag(&self, view_id: ViewId, line: u64, column: u64) -> ClientResult<()> {
    ...
    /// ```
    pub fn new_view(&self, file_path: Option<String>) -> ClientResult<ViewId> {
    ...
    pub fn close_view(&self, view_id: ViewId) -> ClientResult<()> {
        self.notify("close_view", json!({ "view_id": view_id }))
    }

    pub fn save(&self, view_id: ViewId, file_path: &str) -> ClientResult<()> {
        let params = json!({"view_id": view_id, "file_path": file_path});
        Box::new(self.notify("save", params).and_then(|_| Ok(())))
    }

    pub fn set_theme(&self, theme: &str) -> ClientResult<()> {
    ...
    pub fn start_plugin(&self, view_id: ViewId, name: &str) -> ClientResult<()> {
        let params = json!({"view_id": view_id, "plugin_name": name});
        Box::new(self.notify("start", params).and_then(|_| Ok(())))
    }

    pub fn stop_plugin(&self, view_id: ViewId, name: &str) -> ClientResult<()> {
        let params = json!({"view_id": view_id, "plugin_name": name});
    ...
    pub fn replace_next(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "replace_next", None as Option<Value>)
    }

    pub fn replace_all(&self, view_id: ViewId) -> ClientResult<()> {
        self.edit_notify(view_id, "replace_all", None as Option<Value>)
    }

    pub fn set_language(&self, view_id: ViewId, lang_name: &str) -> ClientResult<()> {
        self.notify(
            "set_language",
